	...
	class Click2mail implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			if (strEMailAddr.length() > 0) {
				...
				String sum_pages_string = getSum_pages_string(act);
...
//							+".operation"
	...
	String getSum_pages_string(Activity act){
		String sumPagesStr = "";
