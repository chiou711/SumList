...
public class SelectOftenItem extends Fragment{
	...
	Button add_often_item;
	EditText titleEditText;
	AlertDialog mDialog;
	SetOftenItems_list list_selOftenIem2;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		add_often_item = rootView.findViewById(R.id.btn_add_often_item);
		add_often_item.setOnClickListener(new View.OnClickListener() {
			@Override
	...
	DialogInterface.OnClickListener listener_ok = new DialogInterface.OnClickListener()
	{
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			// refresh listview
			list_selOftenIem2 = new SetOftenItems_list(act,rootView , mListView);
